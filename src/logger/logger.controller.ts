...
export class LoggerController {
    ...
    async list(
        ...
        const rows = await this.loggerService.list({ waMessageId, from, to, status, limit });
        ...
        <head>
            ...
            <style>
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                /* Typography & Link Components */
                a { text-decoration: none; color: #4f46e5; font-family: monospace; font-size: 0.9rem; font-weight: 500; }
        ...
        <body>
            ...
            return `
                    <div class="card">
                        ...
                        <div class="card-meta">
                            <p><b>Created At:</b> <span class="font-mono">${formattedDate}</span></p>
